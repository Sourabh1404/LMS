...
const Header = () => {
  ...
  return (
    <>
      <div className='grid grid-cols-2 bg-[#F5F3EF]'>
        <div className='flex flex-col justify-start items-center text-left break-words  m-10'>
        ...
        <div className='col-start-1 col-end-4 bg-white m-10'>
          ...
          <div className="flex flex-wrap -mx-1 lg:-mx-4 ">
                ...
                <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3 shadow-xl rounded-xl " key={index}>
                  <article className="overflow-hidden rounded-lg ">
                    <header className=" items-center justify-between leading-none p-2 md:p-4">
                      <Link className="flex justify-center items-center no-underline hover:underline text-black" to={`/books/${book._id}`}>
            ...
            <div className="container my-12 mx-auto px-4 md:px-12">
                <h1 className='flex justify-center items-centers m-2 text-6xl font-bold font-serif'>Books</h1>
              <div className="flex flex-wrap -mx-1 lg:-mx-4 ">
                {
                    ...
                    <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3 shadow-xl rounded-xl " key={index}>
                      <article className="overflow-hidden rounded-lg ">
                        ...
                        <Link to={`/api/books/book/${book._id}`}>
                          <a className="flex justify-center items-center no-underline hover:underline text-black" >
                            <img alt="Placeholder" className="flex justify-center items-center rounded-md shadow-lg shadow-[#000]  w-[50%] h-[50%]" src={book.imageLink} />
