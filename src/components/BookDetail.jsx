        ...
        <div className="container mx-auto mt-6">
            ...
            <div class="grid grid-rows-3 grid-flow-col gap-4 bg-[#F5F3EF] p-6">
                ...
                <div class="row-span-2 col-span-2 ...">
                    <p className="text-gray-800 text-2xl font-mono"><span className='text-xl'>Year:</span> {book.year}</p>
                    <p className="text-gray-800 text-2xl font-mono"><span className='text-xl'>Genre:</span> {book.genre}</p>
                    <p className="text-gray-800 text-2xl font-mono"><span className='text-xl'>Description:</span> {book.description}</p>
                    <p className="text-gray-800 text-2xl font-mono"><span className='text-xl'>No. of copies:</span> {book.count}</p>
                </div>
            </div>
        </div>
